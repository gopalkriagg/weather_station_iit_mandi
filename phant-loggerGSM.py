...
publicKey = "o8yy2GDWnXTG8EJrzj14"
privateKey = "yz77mBbywjHb90lojrAV" 
...
############################################
data = {}
fields = ["stationname", "tempdht22", "humidity", "tempbmp", "pressure", "altitude", "sealevelpressure", "rainfall", "windspeed", "winddirection", "bbbtimestamp"] # Weather fields
weatherDataFile = os.path.join(script_dir, "weather.data")
